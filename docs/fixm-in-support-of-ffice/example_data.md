...
- Download XML [here](https://github.com/fixm-ccb/fixm-user-manual-4.3.0-testing/blob/hlepori_example_data_add_xml_files/docs/assets/downloads/example_data_FFICE_IG_E-3.7_basic_route.xml)
...
- Download XML [here](https://github.com/fixm-ccb/fixm-user-manual-4.3.0-testing/blob/hlepori_example_data_add_xml_files/docs/assets/downloads/example_data_FFICE_IG_E-3.7_expanded_route.xml)
...
- Download XML [here](https://github.com/fixm-ccb/fixm-user-manual-4.3.0-testing/blob/hlepori_example_data_add_xml_files/docs/assets/downloads/example_data_FFICE_IG_E-3.7_trajectory.xml)
